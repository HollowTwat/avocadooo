...
async def process_lifestyle(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    lifestlyle_nums_answer_map = {
        ...
        3:"На правах доброго совета: постарайтесь добавлять в свой день немного активности, даже на рабочем месте 🧘‍♀️  Например, прямо сейчас вытяните руки над головой , потянитесь макушкой вверху и почувствуйте как выпрямляется ваш позвоночник. Хорошо, правда?",
